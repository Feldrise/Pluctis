...
class PlantLimitReachedDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      content: const Text("Vous avez atteind la limite de plantes. Si vous voulez en ajouter plus, vous pouvez regarder une publicité où acheter la version premium de Pluctis"),
      actions: <Widget>[
        FlatButton(
          onPressed: () {
